...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'winnie.bulk-delete-operation::fields',
]);
```
...
cp -i vendor/winnie/bulk-delete-operation/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
...
```bash
composer remove winnie/bulk-delete-operation
```
